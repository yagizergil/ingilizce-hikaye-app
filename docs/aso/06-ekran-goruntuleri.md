...
| Kova      | Yedek       | Doğrudan dil öğrenme şablonu, kategori sinyali en güçlü olan bu. Ama mor palet ürünü Duolingo benzeri bir ders uygulaması gibi gösteriyor — oysa fark tam olarak _okuma_ olması. Paleti değiştirilirse Alora'yı seçmemek için sebep kalmıyor. Yalnızca A/B testi için.                                                 |
...
|           |                                                                           |
| --------- | ------------------------------------------------------------------------- |
| **TR**    | Dinle, **kelimeyi takip et**.                                             |
|           | `OKUNAN KELİME METNİN ÜZERİNDE İŞARETLENİR`                               |
| **EN**    | Listen and follow every word.                                             |
|           | `THE SPOKEN WORD IS MARKED AS YOU LISTEN`                                 |
| **Ekran** | Koyu temada reader, bir kelime vurgulu ve başlıkta duraklat ikonu görünür |

Bu kare önceki plandaki "çevrimdışı + koyu tema" karesinin yerine geçti.
Gerekçe: çevrimdışı okuma ve koyu tema _beklenen_ özellikler — bulunmaması
dikkat çeker, bulunması satmaz. Kelime kelime takipli sesli okuma ise
kategoride ayrıştırıcı ve tek karede anlatılabiliyor. Çevrimdışı ve koyu
tema açıklama metnindeki "NELER VAR" listesinde duruyor.

Kare bilerek koyu temada: şeritteki diğer yedi kare açık zeminli, bu ritmi
kırıp göz çekiyor ve aynı anda koyu temanın varlığını da gösteriyor.
